...
// Lives in lib/ (not components/ui/button) because this project already has a
// hand-rolled UiButton at components/ui/Button.vue, and on a case-insensitive
// filesystem `@/components/ui/button` would resolve to that file instead of a
// shadcn button directory. Only the cva variants are needed (by AlertDialog).
